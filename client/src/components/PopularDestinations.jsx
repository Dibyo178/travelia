...
const PopularDestinations = () => {
  const destinations = [
    { name: "Lithaniya - Santa Cruza", price: "359", img: "https://images.unsplash.com/photo-1526481285228-5adc33d40855", location: "ROME", days: "4 Days - 4 Nights" },
    { name: "Velouria - Monte Sienna", price: "850", img: "https://images.unsplash.com/photo-1516483638261-f4dbaf036963", location: "BHUTAN", days: "6 Days - 3 Nights" },
    { name: "Elvarra - Costa Lumia", price: "689", img: "https://images.unsplash.com/photo-1533105079780-92b9be482077", location: "MOROCCO", days: "5 Days - 2 Nights" },
    { name: "Seraphina - Porto Luno", price: "1099", img: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34", location: "VENICE", days: "8 Days - 7 Nights" },
    { name: "Paris - Eiffel Magic", price: "720", img: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34", location: "PARIS", days: "3 Days - 2 Nights" },
  ];
    ...
    <section className="py-20 bg-[#fdf7f0] px-4 lg:px-10">
      ...
      <div className="max-w-7xl mx-auto">
        <Swiper
          ...
          className="pb-16" // পেজিনেশনের জন্য নিচে জায়গা রাখা হয়েছে
        >
            ...
            <SwiperSlide key={idx}>
              <div className="bg-white rounded-[30px] overflow-hidden shadow-sm hover:shadow-xl transition-all group mb-10">
                ...
                <div className="p-6">
                  ...
                  <button className="w-full mt-6 bg-amber-400 text-slate-900 text-[11px] font-black py-4 rounded-xl hover:bg-black hover:text-white transition-all duration-300 uppercase tracking-widest">
                    Explore Trip
                  </button>
                </div>
              </div>
      ...
      {/* Swiper Pagination Style Customization */}
      <style jsx global>{`
